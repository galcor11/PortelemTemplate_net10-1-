...
namespace AuthTemplate.Server.Controllers
{
    ...
    public class BaseController : ControllerBase
    {
        ...
        [HttpPost("makeChangeInServer/{questionId}")]
public async Task<IActionResult> MakeChangeInServer(int gameID, bool isInsert, string query, object param, string errorMessage)
{
    int isSuccessful = 0;
    if (isInsert)
    {
